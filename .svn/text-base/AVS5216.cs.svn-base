...
namespace UV_Quant
{
    ...
    public class AVS5216
    {
        ...
        [DllImport("AS5216.dll")]
        public static extern IntPtr AVS_GetVersionInfo(IntPtr a_hDevice, ref byte a_pFpgaVer, ref byte a_pFirmwareVer, ref byte a_pDllVer);
        ...
        [DllImport("AS5216.dll")]
        public static extern int AVS_GetList(uint a_ListSize, ref uint a_pRequiredSize, ref byte a_pList);
        ...
        [DllImport("AS5216.dll")]
        public static extern IntPtr AVS_GetLambda(IntPtr a_hDevice, ref double a_pWavelength);

        [DllImport("AS5216.dll")]
        public static extern IntPtr AVS_GetNumPixels(IntPtr a_hDevice, ref ushort a_pNumPixel);

        [DllImport("AS5216.dll")]
        public static extern IntPtr AVS_GetParameter(IntPtr a_hDevice, uint a_Size, ref uint a_pRqdSize, ref byte a_pData);

        [DllImport("AS5216.dll")]
        public static extern IntPtr AVS_SetParameter(IntPtr a_hDevice, ref DeviceConfigType a_pDeviceParm);

        [DllImport("AS5216.dll")]
        public static extern int AVS_GetScopeData(IntPtr a_hDevice, ref uint a_pTimeLabel, ref double a_pSpectrum);

        [DllImport("AS5216.dll")]
        public static extern int AVS_GetSaturatedPixels(IntPtr a_hDevice, ref byte a_pSaturated);
